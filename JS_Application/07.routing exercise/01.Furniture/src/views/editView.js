import { getById, updateFurniture } from '/src/api.js';
import { html, userData } from '/src/util.js';

const editTemplate = (data, onSubmit) => html`<div class="container">
      ...
      <div class="col-md-4">
        ...
        <div class="form-group">
          ...
          <input
            ...
            type="text"
            name="img"
            .value=${data.img[0] == '.' ? data.img.slice(1) : data.img}
          />
        </div>
        <div class="form-group">
...
export async function showEdit(context) {
  ...
  async function onSubmit(e) {
    ...
    await updateFurniture(movieId, data);
